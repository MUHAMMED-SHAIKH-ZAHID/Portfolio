...
const Data = () => {
  return (
   ...
   <h3 className="home__title"> Shaikh Zahid   
   <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
   ...
   <p className="home_description">I'm creative developer based 
   in Calicut , and I'm very passionate and dedicated to my work.
   </p>
